...
if(class_exists( 'WP_Customize_control')):
    ...
    */
	class Construction_Light_Repeater_Control extends WP_Customize_Control{
				        ...
				        <div class="cl-repeater-fields">
				            ...
				            <div class="cl-fields cl-type-<?php echo esc_attr( $field['type'] ).' '.esc_attr( $class ); ?>">
				                ...
				                <?php }
				                  ...
				                  switch ( $field['type'] ) {
                                    ...
                                    case 'checkbox':
                                        $checked = '';
                                        if ( 1 == $new_value ) $checked ='checked="checked"';
				                      echo '<input data-default="'.esc_attr($default).'" data-name="'.esc_attr($key).'" type="checkbox" value="'.esc_attr($new_value).'"'. $checked. '/>';
				                    break;
				                    ...
				                    case 'icons':
				                        ...
				                        echo '<ul class="cl-repeater-icon-list clearfix">';
				                          $construction_light_awesome_icon_array = construction_light_awesome_icon_array();

				                          foreach ($construction_light_awesome_icon_array as $cl_awesome_icon) {
				                    ...
				                    case 'upload':
				                        ...
				                        esc_html_e('No image selected', 'construction-light');
				                        echo '</div>';
				                        echo '<div class="thumbnail thumbnail-image">';
				                        echo $image;
				                        echo '</div>';
				                        echo '<div class="actions clearfix">';
				                        echo '<button type="button" class="button cl-delete-button align-left">'.esc_html__('Remove', 'construction-light').'</button>';
				                        echo '<button type="button" class="button cl-upload-button alignright">'.esc_html__('Select Image', 'construction-light').'</button>';
                                    ...
                                    case 'gallery':
                                      ...
                                      <input id="edit-gallery" class="button upload_gallery_button" type="button" value="<?php esc_attr_e('Add/Edit Gallery','construction-light') ?>" />
                                      <input id="clear-gallery" class="button upload_gallery_button" type="button" value="<?php esc_attr_e('Clear','construction-light') ?>" />
				            ...
				            <div class="clearfix cl-repeater-footer">
					            <div class="alignright">
					                <a class="cl-repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'construction-light') ?></a> |
					                <a class="cl-repeater-field-close" href="#close"><?php esc_html_e('Close', 'construction-light') ?></a>
					            </div>
				            </div>
				        </div>
				    </li>
	...
	/**
	  * Multiple Check
	*/
    class Construction_Light_Multiple_Check_Control extends WP_Customize_Control {
    ...
    */
    class Construction_Light_Switch_Control extends WP_Customize_Control{
	 ...
	 * @access public
	 */
	class Construction_Light_Customize_Section_Pro extends WP_Customize_Section {
...
*/
if(!function_exists('construction_light_awesome_icon_array') ){

	function construction_light_awesome_icon_array(){
...
// Upgrade Text
if ( class_exists( 'WP_Customize_Control' ) ) {
	if ( !class_exists( 'Construction_Light_Upgrade_Text' ) ) {
		class Construction_Light_Upgrade_Text extends WP_Customize_Control {

	        public $type = 'construction-light-upgrade-text';
	        ...
	        public function render_content() {
	            ...
	            <label>
	                ...
	                <a href="<?php echo esc_url('https://sparklewpthemes.com/wordpress-themes/constructionlightpro/'); ?>" target="_blank"> <strong><?php echo esc_html__('Upgrade to PRO', 'construction-light'); ?></strong></a>
	            </label>
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	if ( !class_exists( 'Construction_Light_Upgrade_Section' ) ) {
		class Construction_Light_Upgrade_Section extends WP_Customize_Section {
	         ...
	         * @var    string
	         */
	        public $type = 'construction-light-upgrade-section';
	        ...
	        protected function render_template() {
	            ...
	            <li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand">
	                ...
	                <a href="<?php echo esc_url('https://sparklewpthemes.com/wordpress-themes/constructionlightpro/'); ?>" class="button button-primary" target="_blank"><?php echo esc_html__('Upgrade to Pro', 'construction-light'); ?></a>
	            </li>
	            <?php
	        }
	    }
